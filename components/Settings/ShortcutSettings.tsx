    ...
    <div className={`p-4 space-y-6 ${className}`}>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="text-sm text-[var(--text-secondary)] mt-1">
              Use keyboard shortcuts to quickly access extension features. Press{' '}
              <kbd className="px-1 py-0.5 bg-[var(--bg-tertiary)] rounded text-xs">
                ?
              </kbd>{' '}
              in the popup to see all available shortcuts.
            </div>
          </div>
        </div>
      </div>
      ...
      {Object.entries(groupedShortcuts).map(([category, categoryShortcuts]) => (
        <div key={category} className="space-y-3">
          <div className="flex items-center space-x-2">
            ...
            <h4 className="text-md font-medium text-[var(--text-primary)] capitalize">
              {category}
            </h4>
          </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${getCategoryColor(shortcut.category)}`}
                      >
                        {shortcut.category}
                      </span>
                    </div>
      ...
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-lg p-4">
        <h4 className="text-sm font-medium text-[var(--text-primary)] mb-3">
          Additional In-Page Shortcuts
        </h4>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
          <div className="flex justify-between">
            <span className="text-[var(--text-secondary)]">
              Toggle Tracking Overlay:
            </span>
            <kbd className="px-1 py-0.5 bg-[var(--bg-tertiary)] rounded text-xs font-mono text-[var(--text-primary)]">
              Ctrl+Shift+T
            </kbd>
          </div>
          <div className="flex justify-between">
        ...
        <div className="text-xs text-[var(--text-tertiary)] mt-3">
          * In-page shortcuts work when browsing websites and cannot be
          customized.
        </div>
      </div>
      ...
      <div className="bg-[var(--warning)]/10 border border-[var(--warning)]/20 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <div className="text-sm text-[var(--text-secondary)] mt-1">
              On Mac,{' '}
              <kbd className="px-1 py-0.5 bg-[var(--bg-tertiary)] rounded text-xs text-[var(--text-primary)]">
                Ctrl
              </kbd>{' '}
              is replaced with{' '}
              <kbd className="px-1 py-0.5 bg-[var(--bg-tertiary)] rounded text-xs text-[var(--text-primary)]">
