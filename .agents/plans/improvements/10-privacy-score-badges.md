...
```typescript
async function updateTabBadge(tabId: number, events: TrackingEvent[]): Promise<void> {
...
async function updateTooltip(tabId: number, summary: PrivacySummary): Promise<void> {
  const tooltipText = `
